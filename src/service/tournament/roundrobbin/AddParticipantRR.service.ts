...
const addParticipantInRRTournament = async (tournamentID: string, participantName: string) => {
    ...
    try {
        ...
        console.log("Error in add participant Round Robbin service : ", message);
        throw new AppError(statusCode, message);
    }
}


export default addParticipantInRRTournament;